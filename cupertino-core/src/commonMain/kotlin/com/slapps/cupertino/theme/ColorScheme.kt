...
@Composable
@InternalCupertinoApi
fun isInitializedCupertinoTheme(): Boolean = LocalColorScheme.current !== defaultCupertinoColorScheme
...
internal object ColorSchemeTokens {
    ...
    val lightSecondaryLabel: Color =
        color(
            accessible = 0xcc3c3c43,
            default = 0x993c3c43,
        )
    val lightTertiaryLabel: Color =
        color(
            accessible = 0xb23c3c43,
            default = 0x4c3c3c43,
        )
    val lightQuaternaryLabel: Color =
        color(
            accessible = 0x8c3c3c43,
            default = 0x2d3c3c43,
        )
    val lightSystemFill: Color =
        color(
            accessible = 0x47787880,
            default = 0x5b787880,
        )
    val lightSecondarySystemFill: Color =
        color(
            accessible = 0x3d787880,
            default = 0x51787880,
        )
    val lightTertiarySystemFill: Color =
        color(
            accessible = 0x33767680,
            default = 0x3d767680,
        )
    val lightQuaternarySystemFill: Color =
        color(
            accessible = 0x28747480,
            default = 0x2d767680,
        )

    val lightPlaceholderText: Color =
        color(
            accessible = 0xb23c3c43,
            default = 0x4c3c3c43,
        )
    val lightSeparator: Color =
        color(
            accessible = 0x5e3c3c43,
            default = 0x493c3c43,
        )
    val lightOpaqueSeparator: Color =
        color(
            accessible = 0xffc6c6c8,
            default = 0xffc6c6c8,
        )
    val lightLink: Color = Color(0xff007aff)
    val lightSystemGroupedBackground: Color =
        color(
            accessible = 0xffebebf0,
            default = 0xfff2f2f7,
        )
    val lightSecondarySystemGroupedBackground: Color = Color.White
    val lightTertiarySystemGroupedBackground: Color =
        color(
            accessible = 0xffebebf0,
            default = 0xfff2f2f7,
        )
    val lightSystemBackground: Color = Color.White
    val lightSecondarySystemBackground: Color =
        color(
            accessible = 0xffebebf0,
            default = 0xfff2f2f7,
        )
    ...
    val darkSecondaryLabel: Color =
        color(
            accessible = 0xb2ebebf5,
            default = 0x99ebebf5,
        )
    val darkTertiaryLabel: Color =
        color(
            accessible = 0x8cebebf5,
            default = 0x4cebebf5,
        )
    val darkQuaternaryLabel: Color =
        color(
            accessible = 0x66ebebf5,
            default = 0x28ebebf5,
        )
    val darkSystemFill: Color =
        color(
            accessible = 0x70787880,
            default = 0x5b787880,
        )
    val darkSecondarySystemFill: Color =
        color(
            accessible = 0x66787880,
            default = 0x51787880,
        )
    val darkTertiarySystemFill: Color =
        color(
            accessible = 0x51767680,
            default = 0x3d767680,
        )
    val darkQuaternarySystemFill: Color =
        color(
            accessible = 0x42767680,
            default = 0x2d767680,
        )
    val darkPlaceholderText: Color =
        color(
            accessible = 0x8cebebf5,
            default = 0x4cebebf5,
        )
    val darkSeparator: Color =
        color(
            accessible = 0xad545458,
            default = 0x99545458,
        )
    val darkOpaqueSeparator: Color =
        color(
    ...
    val darkSecondarySystemGroupedBackground: Color =
        color(
            accessible = 0xff242426,
            default = 0xff1c1c1e,
        )
    val darkTertiarySystemGroupedBackground: Color =
        color(
            accessible = 0xff363638,
            default = 0xff2c2c2e,
        )
    val darkSystemBackground: Color = Color.Black
    val darkSecondarySystemBackground: Color =
        color(
            accessible = 0xff242426,
            default = 0xff1c1c1e,
        )
    val darkTertiarySystemBackground: Color =
        color(
            accessible = 0xff363638,
            default = 0xff2c2c2e,
        )
